...
workout1 = Workout.create!(name: 'Bench and Squats', user_id: user9.id)
workout2 = Workout.create!(name: 'Cardio and Plyo', user_id: user9.id)
workout3 = Workout.create!(name: 'Bench and Squats', user_id: user9.id)
workout4 = Workout.create!(name: 'Cardio and Plyo', user_id: user9.id)
workout5 = Workout.create!(name: 'Bench and Squats', user_id: user9.id)
workout7 = Workout.create!(name: 'Cardio and Plyo', user_id: user9.id)
workout8 = Workout.create!(name: 'Bench and Squats', user_id: user9.id)
workout9 = Workout.create!(name: 'Cardio and Plyo', user_id: user9.id)
workout10 = Workout.create!(name: 'Bench and Squats', user_id: user9.id)
workout6 = Workout.create!(name: 'Cardio and Plyo', user_id: user9.id)
...
exercise10 = Exercise.create!(exercise_name: "Push-up", ex_type: 'bodyweight')
...
exercise17 = Exercise.create!(exercise_name: "Pull-up", ex_type: 'bodyweight')
